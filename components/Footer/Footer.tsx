      ...
      <Grid stackable>
        <Grid.Row>
          ...
          <Grid.Column width={7}>
            ...
            <p>
              Conocer distintos tipos de Avocados {''}
              <a href="https://twitter.com/dannzdev">@dannzdev</a>
            </p>
            <List horizontal style={{ display: 'flex' }}>
              <List.Item
                icon="twitter"
                style={{ display: 'flex' }}
                content={<a href="https://twitter.com/dannzdev">Twitter</a>}
              />
              <List.Item
                icon="github"
                style={{ display: 'flex' }}
                content={
                  <a href="https://github.com/dannzdev/Avocado-Store">
                    GitHub
                  </a>
                }
              />
